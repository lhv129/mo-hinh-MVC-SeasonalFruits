...
<body>
    <!-- header -->
        ...
        <div class="tablecell-pages text-center">
            <div class="container">
                <h1 class="text-title-pages">Create Product</h1>
            </div>
        </div>
    </div>
    <!-- end header -->
                    ...
                    <form action="" enctype="multipart/form-data" method="POST">
                        ...
                        <select name="catalogue_id">
                            <?php foreach ($category as $listCategory) {
                                ?>
                                <option value="<?php echo $listCategory['id'] ?>">
                        ...
                        <input type="text" name="code" value="<?php if(isset($_SESSION['data']['code'])) echo $_SESSION['data']['code']; ?>">
                        ...
                        <input type="text" name="name" value="<?php if(isset($_SESSION['data']['name'])) echo $_SESSION['data']['name']; ?>">
                        ...
                        <label for="">Gía:</label>
                        <input type="number" name="price_regular" value="<?php if(isset($_SESSION['data']['price_regular'])) echo $_SESSION['data']['price_regular']; ?>">
                        ...
                        <input type="text" name="content" value="<?php if(isset($_SESSION['data']['content'])) echo $_SESSION['data']['content']; ?>">
